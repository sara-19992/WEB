                                        ...
                                        <div style="margin-top: 0px;margin-right: 25px;">
                                            <div style="margin-top: -150px;width: 1170px;background-color:white;border:solid 2 px ;border-color:black;height: 200px;">
                                                <label class="container">
                                                    ...
                                                    <p style="width:150px;margin-right:-60px;padding-top:5px;font-family:'Changa';font-size: 14px;">إضافة حرفة جديدة</p>
                                                </label>
                                                <input name="name" type="text" id="nameof" onchange="something(this.value)"style="border:black 1px solid;margin-top:10px;margin-right:10px;margin-left:840px;width: 800px;height:35px;padding:10px;font-family:'Changa';font-size: 13px;" type="text" placeholder="اسم الحرفة" name="uname" required>

                                                <div>
                                                    <div class="custom-file">
                                                        <input type="file" name="filename"onchange="something1(this.value)" id="inputGroupFile01" class="img Inp custom-file-input" aria-describedby="inputGroupFileAddon01">
                                                    ...
                                                    <div class="container " style="margin-right:1075px;width: 70px;height:70px;margin-top:-85px;background-color:transparent">
<!--                                                            <input type="text" name="name" id="somethinghere" style="visibility: hidden">-->
<!--                                                            <input type="text" name="filename" style="visibility: hidden">-->
                                                            <div id='img_container'><img id="preview" style="width: 70px;height: 70px" src="https://webdevtrick.com/wp-content/uploads/preview-img.jpg" alt="your image" title=''/></div>
                                                            </div>
                                                           <button type="submit"id="button2"style="margin-top:5px;border:none;background-color: #D7D5D5;margin-left:12px;font-family:'Changa';font-size: 13px;height:35px;width:1145px;text-align:center">إضافة</button>
                                                    </div>
                                                </div>
...
<!--                                        </div>-->
                                    ...
                                    <form method="post" action="delete_jop.php">
                                        <div style="margin-top: -50px;margin-right:-1180px;width: 1100px;background-color:white;border:solid 2 px ;border-color:black;height: 150px;">
                                            <label class="container">
                                                <input type="radio" style="margin-top: 10px" checked="checked" name="radio">
                                                <p style="width:150px;margin-right:-100px;padding-top:5px;font-family:'Changa';font-size: 14px;">حذف حرفة</p>
                                            </label>
                                            <p style="width:80px;margin-right:-20px;padding-top:5px;font-family:'Changa';font-size: 14px;">اختيار حرفة</p>
                                            <div style="margin-top:-35px;margin-left:870px">
                                                <select type="text" name="name" style="padding: 4px;width: 150px;padding-left:10px;font-family:'Changa';font-size: 13px;">
                                                    <?php
                                            ...
                                            <div>
                                                ...
                                                <button type="submit"id="button2"style="margin-top:20px;border:none;background-color: #D7D5D5;margin-left:100px;font-family:'Changa';font-size: 13px;height:35px;width:1145px;text-align:center">حذف</button>
                                            </div>
                                        </div>
