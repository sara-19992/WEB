                            ...
                            <div class="mdc-list-group">
                                <nav class="mdc-list mdc-drawer-menu">
                                    ...
                                    <div class="mdc-list-group">
                                        <nav class="mdc-list mdc-drawer-menu">
                                            <div class="mdc-list-item mdc-drawer-item">
                                                <a class="mdc-drawer-link" href="../forms/basic-forms.php"style="font-family:'Changa';font-size: 17px;">
                                                    <i class="material-icons mdc-list-item__start-detail mdc-drawer-item-icon" aria-hidden="true">grid_on</i>
                                                    اضافة حرفة جديدة
                                                </a>
                                            </div>
                                            <div class="mdc-list-group">
                                                <nav class="mdc-list mdc-drawer-menu">
                                                    <div class="mdc-list-item mdc-drawer-item">
                                                        <a class="mdc-drawer-link" href="../forms/basic-forms.php"style="font-family:'Changa';font-size: 17px;">
                                                             <i class="material-icons mdc-list-item__start-detail mdc-drawer-item-icon" aria-hidden="true">search</i>
                                                            بحث
...
<!--                            <label for="exampleInputEmail1">البحث عن طريق الاسم</label>-->
                            <input id="searchdata" type="text" name="searchdata" required="true" class="form-control">

                            <br>
                            <div id="serachby" >
                                <br>
                            <button type="submit" name="search" class="btn btn-primary btn-sm" >الاسم</button>
                            <button type="submit" name="search" class="btn btn-primary btn-sm">رقم التلفون</button>
                                <button type="submit" name="search" class="btn btn-primary btn-sm">العمل</button>
                            </div>
                            </form>
                        </div>
                            ...
                            <div class="mdc-card p-0">
                                ...
                                <table class="" style="font-family:'Changa';font-size: 16px;">
                                    ...
                                    <thead>                                    <tr>
                                        ...
                                        <th style="width: 100px;">الاسم الاول</th>
                                        <th style="width: 100px;">اسم العائلة</th>
                                    ...
                                    <td style="padding-top: 40px;vertical-align: top"><?php echo $row1['avalibel']?></td>
                                    <td style="padding-top: 40px;vertical-align: top"><?php echo $row1['namefirst']?></td>
                                    <td style="padding-top: 40px;vertical-align: top"><?php echo $row1['namelast']?></td>
                                    ...
                                    <td>
                                        ...
                                        <form action="deletewroker.php" method="post"onsubmit="return confirm('هل أنت متأكد من أنك تربد ازالة هذا الحرفي من التطبيق ؟');"style="margin-top: -5px">
                                            ...
                                            <button class="Accept_Not" style="border:none;background-color:white;margin-top:-30px;font-family: Changa"type="submit"id="button2">حذف صنايعي </button><i class="fa fa-trash"></i>
                                        </form >
