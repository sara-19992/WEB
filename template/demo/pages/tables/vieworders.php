              ...
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                  <table id="customers"style="margin-top: -180px;margin-right:250px">
                      <tr>
                          ...
                          <th style="width: 130px;">وقت الطلب</th>
                          <th style="width: 120px;">تاريخ الطلب</th>
                          <th style="width: 330px;">وصف الطلب</th>
                      </tr>
                      <?php
                      ...
                      $sql1 = "select all_order.*,users.*,worker.namefirst as name1,worker.namelast as name2 from  worker,all_order,users where all_order.phoneuser=users.phone and all_order.phoneworker=worker.phone";
                      $res1 = $db->query($sql1);
                      $i=0;
                      $j=0;
                      ...
                      <td style="vertical-align: top"><?php $am_pm='';if($row1['Am_Pm']=='am'){$am_pm='صباحا';}else if($row1['Am_Pm']=='pm'){$am_pm='مساء';}echo $row1['timestart']." - ".$row1['timeend']."  "." ".$am_pm?></td>
                      <td style="vertical-align: top"><?php echo $row1['date']?></td>
                      <td style="vertical-align: top"><?php echo $row1['description']?></td>
                      </tr>
                      <tr>
                          <?php
                          } ?>
