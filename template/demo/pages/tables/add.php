...
$res2t=$db->query("INSERT INTO `worker` (`name`,`namefirst`, `namelast`, `pass` , `phone`, `image` , `Work` , `Experiance` , `Information` ,  `token`,`country`) VALUES ('$name','$namefirst' ,'$namelast', '$pass','$phone','$imagename','$ًWork','$Experiance','$Information','$token','$country')");
