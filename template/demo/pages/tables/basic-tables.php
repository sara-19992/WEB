              ...
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                  <table id="customers"style="margin-top: -180px;margin-right:250px">
                      <tr>
                          ...
                          <th style="width: 310px;">معلومات عامة</th>
                          <th style="width: 310px;">خبرات سابقة</th>
                      ...
                      <td style="vertical-align: top">
                          <?php echo $row1['namefirst']." ".$row1['namelast']?>
                      </td>
...
<!--                          <button onclick="document.getElementById('id01').style.display='block'" style="width:auto;">قيول الطلب</button>-->
                          <button class="Accept_Not" onclick="document.getElementById('id01').style.display='block'"style="width:110px;height:30px;border:none;background-color:transparent;color:black;font-family: Changa;font-size:13px;font-weight:bold;margin-top:-30px;text-align:right;padding-left:20"> قبول الطلب      <i class="fa fa-check"style="color:green;padding-left: 0;alignment: left"></i></button>

                          <button class="Accept_Not" onclick="document.getElementById('id02').style.display='block'"style="width:110px;height:30px;border:none;background-color:transparent;color:black;font-family: Changa;font-size:13px;font-weight:bold;margin-top:-30px;text-align:right;padding-left:20">  رفض الطلب      <i class="fa fa-trash"style="word-spacing: 10px;padding-left: 0;alignment: left"></i></button>
<!--                          <button onclick="document.getElementById('id01').style.display='block'" style="width:auto;"> رفض الطلب</button>-->
                          ...
                          <div id="id02" class="modal">
                              ...
                              <form class="modal-content animate"action="delete.php"method="post">
                                  ...
                                  <div class="container" style="background-color:white;alignment: left;margin-right: 100">
                                      <p style="margin-top: 15;padding-top: 100; white-space:pre-line;"> هل أنت متأكد من حذف الطلب ؟</p>
                                      <input type="text" name="phone1" value="<?php echo $row1['phone']?>"style="visibility: hidden">
                                      <button type="submit"class="aceptbtn"id="button3">حسنا</button>
...
<!--                              <input type="text" name="phone" value="--><?php //echo $row1['phone'];?><!--"style="visibility: hidden">-->
<!--                              <button class="Accept_Not" style="border:none;background-color:transparent;font-family: Changa;margin-top: -200px;font-size:13px;font-weight:bold;"type="submit"id="button2">  رفض الطلب</button><i class="fa fa-trash"></i>-->
<!--                          </form >-->
                      </td>
                      </tr>
                      <tr>
